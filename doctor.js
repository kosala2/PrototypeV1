   ...
   //  });
    ...
    if(!userAccount){
     ...
     $("#addCredit").click(function(){
         ...
         // _web3.eth.sendTransaction({from:"0x2889392d845BAA82802532D627558BEe86653DE8", to:userAccount,value: web3.utils.toWei('10', 'ether'), gasLimit: 35000, gasPrice: 20000000000}); //Node 1
          _web3.eth.sendTransaction({from:"9da05c542a7327dc36e1a1060d4165ff339b7870", to:userAccount,value: web3.utils.toWei('10', 'ether'), gasLimit: 35000, gasPrice: 20000000000}); //Node 3
     });
